...
let levyAssetId = new AssetId("server", "testmosaic");
let levy = new AssetLevy(AssetLevyType.Percentil, new Address(""), levyAssetId, 5);
let assetTransferable = new AssetTransferable(new AssetId("server", "mosaic"), new AssetProperties(0, 10000000, true, false), 100000, levy);
